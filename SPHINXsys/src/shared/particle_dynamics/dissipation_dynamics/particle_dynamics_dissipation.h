...
namespace SPH
{
	...
	template <typename DataType, class CoefficientType>
	class BaseDampingSplittingWithWallFlux : public BaseDampingSplittingWithWall<DataType, CoefficientType>
	{
	public:
		template <typename CoefficientArg>
		...
		virtual ~BaseDampingSplittingWithWallFlux() {};
	...
	template <typename DataType>
	using DampingSplittingWithWallFlux = BaseDampingSplittingWithWallFlux<DataType, ConstantCoefficient<Real>>;
	template <typename DataType>
	using DampingSplittingWithWallFluxCoefficientByParticle = BaseDampingSplittingWithWallFlux<DataType, CoefficientByParticle<Real>>;
